...
namespace CustomNetworking
{
    ...
    /// </summary>
    public enum callbacks { UPDATE, CHANGE, CREATE, JOIN, UNDO, SAVE, MASTER }
    public class SSOffical
    {
        ...
        private struct ReceiveRequest
        {
            ...
            public object Payload { get; set; }
            public callbacks whichCB { get; set; }
        }
        ...
        private Queue<ReceiveRequest> changeRequests;
        private Queue<ReceiveRequest> updateRequests;
        ...
        /// </summary>
        public SSOffical(Socket s, Encoding e)
        {
            updateRequests = new Queue<ReceiveRequest>();
            changeRequests = new Queue<ReceiveRequest>();
        ...
        private void ProcessReceiveQueue()
        {
            lock (receiveRequests)
            {
                ...
                while (receivedLines.Count() > 0 && (receiveRequests.Count() > 0))// || updateRequests.Count() > 0 || changeRequests.Count() > 0))
                {
