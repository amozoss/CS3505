...
namespace StringSocketTester
{
    ...
    public class StringSocketTest
    {
        ...
        ///</summary>
        [TestMethod()]
        public void TestBeginReceive()
        {
            new TestBeginReceiveClass().run();
        }

        public class TestBeginReceiveClass
        {
            ...
            public void run()
            {
                ...
                // Obtain the sockets from thtwoe  ends of the connection.  We are using the blocking AcceptSocket()
                ...
                Thread.Sleep(2000);
                receiveSocket.BeginReceive((s, o, p) => { s = ""; }, null);
                receiveSocket.BeginReceive((s, o, p) => { s = ""; }, null);
        ...
        /// <summary>
        /// Sends a newline character over the socket,
        /// then checks whether or not an empty string
        /// is received, as specified.
        /// </summary>
        [TestMethod()]
        public void EmptySendReceive()
        {
            new EmptySendReceiveClass().run();
        }

        public class EmptySendReceiveClass
        {
            // Data that is shared across threads
            private ManualResetEvent mre1;
            private String s1;
